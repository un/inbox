...
export interface Adapter {
     ...
     */
    updateAuthenticatorCounter?(authenticator: Pick<AdapterAuthenticator, "credentialID">, newCounter: number): Awaitable<AdapterAuthenticator | null>;
    /**
     ...
     * If the retrieval fails for some other reason, the adapter must throw an error.
     */
    listAuthenticatorsByAccountId?(accountId: string): Awaitable<AdapterAuthenticator[] | null>;
    /**
     ...
     * If the retrieval fails for some other reason, the adapter must throw an error.
     */
    getAuthenticator?(credentialId: Uint8Array): Awaitable<AdapterAuthenticator | null>;
    /**
