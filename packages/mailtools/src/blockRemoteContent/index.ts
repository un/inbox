 ...
 */
function blockRemoteContentCheerio($: CheerioAPI, replacements: ReplacementOptions = {}) {
 ...
 */
function blockRemoteContent(html: string, replacements: ReplacementOptions = {}): string {
  const $ = load(html);
