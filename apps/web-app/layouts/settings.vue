...
<template>
  <div
    ...
    <div
      ...
      <div
        class="w-full grid grid-cols-4 justify-between p-4 h-full max-h-full overflow-hidden">
        <SettingsSidebar class="h-full max-h-full" />
        <div
          class="flex-col flex justify-center gap-2 items-center w-full col-span-3 pl-4 h-full max-h-full overflow-hidden">
          <slot />
        </div>
      </div>
    </div>
