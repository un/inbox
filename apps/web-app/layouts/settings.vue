  ...
  <div
    ...
    <div
      ...
      <div
        ...
        <div
          class="border-gray-200 col-span-2 h-full max-h-full w-full flex flex-col items-center justify-center gap-2 overflow-hidden border border-b-0 border-l-1 border-r-0 border-t-0 pl-4">
          <slot />
        </div>
      </div>
    </div>
