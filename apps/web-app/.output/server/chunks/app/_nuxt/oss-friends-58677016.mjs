import { useSSRContext, defineComponent, computed, ref, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString } from 'vue';
import { h as useSeoMeta, b as appConfig, u as useAppConfig, _ as _export_sfc, n as navigateTo, a as __nuxt_component_1$3 } from '../server.mjs';
...
import { a as defineOgImageStatic } from './defineOgImage-7646755d.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'klona';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    const ui = computed(() => defu({}, props.ui, appConfig2.ui.kbd));
    return {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<kbd${ssrRenderAttrs(mergeProps({
    class: [_ctx.ui.base, _ctx.ui.size[_ctx.size], _ctx.ui.padding, _ctx.ui.rounded, _ctx.ui.font, _ctx.ui.background, _ctx.ui.ring]
  }, _attrs))}>`);
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxthq+ui-edge@2.3.0-28109578.cbc8ef1_vue@3.3.4_webpack@5.86.0/node_modules/@nuxthq/ui-edge/dist/runtime/components/elements/Kbd.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    const appConfig2 = useAppConfig();
    const ui = computed(() => defu({}, props.ui, appConfig2.ui.tooltip));
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.open && !_ctx.prevent) {
    _push(`<div class="${ssrRenderClass([_ctx.ui.container, _ctx.ui.width])}"><div class="${ssrRenderClass([_ctx.ui.base, _ctx.ui.background, _ctx.ui.rounded, _ctx.ui.shadow, _ctx.ui.ring])}">`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxthq+ui-edge@2.3.0-28109578.cbc8ef1_vue@3.3.4_webpack@5.86.0/node_modules/@nuxthq/ui-edge/dist/runtime/components/overlays/Tooltip.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "m-4 w-auto flex flex-row justify-between" }, _attrs))}><div class="font-display text-3xl cursor-pointer p-1">UnInbox</div><div class="flex flex-row gap-4 items-center">`);
  _push(ssrRenderComponent(_component_UTooltip, { text: "Star on GitHub" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_UIcon, {
          name: "i-mdi-github",
          class: "text-2xl",
          onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("https://github.com/uninbox/UnInbox", { external: true })
  ...
  _push(ssrRenderComponent(_component_UTooltip, { text: "Follow on Twitter" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_UIcon, {
          name: "i-mdi-twitter",
          class: "text-2xl",
          onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("https://twitter.com/UnInbox", { external: true })
        }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_UIcon, {
  ...
  _push(ssrRenderComponent(_component_UTooltip, { text: "Join on Discord" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_UIcon, {
          name: "i-mdi-discord",
          class: "text-2xl",
          onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("https://discord.gg/QMV9p9sgza", { external: true })
        }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_UIcon, {
  ...
  _push(ssrRenderComponent(_component_UTooltip, { text: "Call on Cal.com" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="font-display text-2xl"${_scopeId}> Cal </div>`);
      } else {
        return [
          createVNode("div", {
            class: "font-display text-2xl",
            onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("https://cal.com/mc/un", { external: true })
          }, " Cal ", 8, ["onClick"])
        ];
      }
    }),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/top-nav.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-col justify-center items-center gap-8 container m-auto mb-16"><h1 class="text-7xl font-display mt-16">Our Open Source Friends</h1><p class="max-w-prose"> We believe in a better and more sustainable future powered by Open Source software. Below you can find a list of our friends who are just as passionate about open source and the future as we are. </p><div class="grid grid-flow-row gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-16"><!--[-->`);
      ssrRenderList(OSSFriends, (friend) => {
        _push(`<div class="border-2 p-8 rounded-md border-gray-600 flex flex-col items-center gap-4 bg-blue-500/10 hover:border-gray-400 transition-colors cursor-pointer"><h3 class="font-display text-2xl">${ssrInterpolate(friend.name)}</h3><p class="max-w-prose">${ssrInterpolate(friend.description)}</p></div>`);
      });
      _push(`<!--]--></div></div></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/oss-friends.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=oss-friends-58677016.mjs.map
