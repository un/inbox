  ...
  try {
    const email = await $fetch(config.emailApiUrl, {
      ...
      body: JSON.stringify({
        ...
        subject: "Welcome to the UnInbox Waitlist! \u{1F389}",
