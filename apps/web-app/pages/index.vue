...
async function registerWaitlist() {
  ...
  if (res.success) {
    toast.add({
      ...
      description: 'Please check your email for confirmation, it should already be there 👀',
      color: 'green',
      timeout: 60000
    });
    showConfirmation.value = true;
...
"
          ...
          <div
            class="border-2 p-8 rounded-md border-gray-600 flex flex-col items-center gap-4 bg-blue-500/10 hover:border-gray-400 transition-colors cursor-pointer"
            @click="navigateTo('https://discord.gg/QMV9p9sgza', { external: true })">
            <UIcon
              name="i-mdi-discord
"
          ...
          <div
            class="border-2 p-8 rounded-md border-gray-600 flex flex-col items-center gap-4 bg-blue-500/10 hover:border-gray-400 transition-colors cursor-pointer"
            @click="navigateTo('https://github.com/uninbox/UnInbox', { external: true })">
            <UIcon
              name="i-mdi-github
"
        ...
        <UBadge
          ...
          Check out our Open Source Friends. Life is better with friends, but even better open source!
        </UBadge>
      </div>
    </div>
  </div>
