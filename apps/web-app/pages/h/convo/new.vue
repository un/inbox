<script setup lang="ts">
  ...
  const participantUsersExpanded = ref(false);
  const participantGroupsExpanded = ref(false);
  const participantEmailExpanded = ref(false);
...
<template>
  <div class="h-full max-h-full max-w-full w-full flex flex-col gap-8">
      ...
      <div class="flex flex-col gap-1">
        <button
          ...
          <span class="text-sm font-medium">
            Add Users
            <span class="text-xs"> (You are already included) </span>
          </span>
        </button>
        <div
          v-if="participantUsersExpanded"
