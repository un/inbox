...
Generally, we do not use GitHub as a support forum. For any usage questions that are not specific to the project itself, please ask on [Discord](https://discord.com/invite/QMV9p9sgza) instead. By doing so, you are more likely to quickly solve your problem, and you will allow anyone else with the same question to find the answer. This also allows maintainers to focus on improving the project for others.
...
_Based on [jessesquires community health files](https://github.com/jessesquires/.github/tree/main)_
